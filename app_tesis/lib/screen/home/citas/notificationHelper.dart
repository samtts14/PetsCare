...
class NotificationHelper {
  ...
  initializedNotification() async {
    androidInitializationSettings = AndroidInitializationSettings('@android:color/white');
    iosInitializationSettings = IOSInitializationSettings(
  ...
  Future<void> showNotificationBtweenInterval() async {
    ...
    if (currentTime.millisecondsSinceEpoch >=
      ...
      await flutterLocalNotificationsPlugin.show(0, "PetsCare",
          "Cita pendiente", notificationDetails);
    }
